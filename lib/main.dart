...
class MainScreen extends StatelessWidget {
            ...
            return Column(
              ...
              children: [
                if (!running) ...[
                  ...
                  audioPlayerButtonQueueOne(),
                  audioPlayerButtonQueueTwo(),
                ] else ...[
  ...
  ElevatedButton audioPlayerButtonQueueOne() => startButton(
        'AudioPlayer Q1',
        () {
          AudioService.start(
  ...
  ElevatedButton audioPlayerButtonQueueTwo() => startButton(
        'AudioPlayer Q2',
        () {
          AudioService.start(
            backgroundTaskEntrypoint: audioPlayerTaskEntrypoint,
